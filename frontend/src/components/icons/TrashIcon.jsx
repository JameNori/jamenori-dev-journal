export function TrashIcon({ className, stroke = "currentColor" }) {
  return (
    <svg
      className={className}
      width="24"
    ...
    >
      <path d="M10 15L10 12" stroke={stroke} strokeLinecap="round" />
      <path d="M14 15L14 12" stroke={stroke} strokeLinecap="round" />
      <path
